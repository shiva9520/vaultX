...
const TabButton = ({ options, isFocused, onPress, onLongPress, route }: any) => {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.8}
    >
      <Animated.View style={[StyleSheet.absoluteFill, styles.activeBackground, animatedBackgroundStyle, { backgroundColor: 'rgba(91, 46, 255, 0.15)' }]} />
      <View style={styles.iconContainer}>
        {options.tabBarIcon ? options.tabBarIcon({ focused: isFocused, color: isFocused ? themeColors.primary : themeColors.textSecondary, size: 22 }) : null}
      </View>
      <Animated.Text style={[styles.label, animatedTextStyle, { color: themeColors.primary }]} numberOfLines={1}>
